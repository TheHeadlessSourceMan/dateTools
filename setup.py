...
def cmdline(args):
    ...
    setup(
        name=name,
        version='1.0',
        description='Handy tools for working with dates, including the ability to smartly use arbitrarily-formatted date time strings into python datetime objects',
